...
export function AnalysesTab({ analyses, isLoading = false, onDelete }: AnalysesTabProps) {
    ...
    <AdvancedCard hover={false}>
      <CardHeader className="pb-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2 sm:pt-4">
          ...
          <Badge variant="secondary" className="self-start sm:self-center px-4 py-1.5 text-sm font-medium bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 border-blue-100 dark:border-blue-800">
