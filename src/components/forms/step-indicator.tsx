...
export function StepIndicator({ steps, currentStep }: StepIndicatorProps) {
  return (
    <div className="mb-8 px-4">
      {/* Desktop Layout */}
      <div className="hidden md:flex items-center justify-center space-x-8 max-w-2xl mx-auto">
            ...
            <div key={step.id} className="flex items-center">
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 max-w-24 leading-tight">
                    {step.description}
                  </p>
                </div>
              </motion.div>
      ...
      <div className="md:hidden w-full max-w-sm mx-auto">
        ...
        <div className="flex items-center justify-center mb-4">
          <div className="flex items-center space-x-1 bg-gray-100 dark:bg-gray-800 rounded-full p-2 w-full">
            {steps.map((step, index) => {
              const isCompleted = step.id < currentStep;
              const isCurrent = step.id === currentStep;
              ...
              return (
                <React.Fragment key={step.id}>
                  <motion.div
                    className={`
                      relative w-8 h-8 rounded-full flex items-center justify-center text-white border-2 transition-all duration-300
                      ${isCompleted 
